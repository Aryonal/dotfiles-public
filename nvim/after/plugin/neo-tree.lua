...
vim.keymap.set("n", "-",
    function()
        vim.cmd("Neotree reveal toggle " .. vim.fn.expand("%:h"))
    end,
    { desc = "[NeoTree] Toggle" }
)
vim.keymap.set("n", "_", "<cmd>Neotree reveal toggle .<cr>", { desc = "[NeoTree] Toggle" })
...
neotree.setup({
    ...
    window = {
        ...
        mappings = {
            ...
            ["d"] = "delete",
            ["<C-s>"] = "open_split",  -- "open_split" or "split_with_window_picker",
            ["<C-t>"] = "open_tabnew",
            ["<C-v>"] = "open_vsplit", -- "open_vsplit" or "vsplit_with_window_picker",
            ["<C-r>"] = "refresh",
            ["R"] = "refresh",
            ["r"] = "rename",
            -- disables
