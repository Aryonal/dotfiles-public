...
function M.setup(opts)
    local util = require("customs.sessions.utils")
    ...
    require("customs.sessions.cmd").autosave_on_leave(opts, group)
    require("customs.sessions.cmd").autoload_on_enter(opts, group)

    ---set up commands
    require("customs.sessions.cmd").create_cmd_save(opts)
    require("customs.sessions.cmd").create_cmd_load(opts)
