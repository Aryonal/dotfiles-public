local vim_utils = require("x.helper.vim")
local vim_hl = require("x.helper.vim.hl")
local color = require("x.helper.color")

---@class customs.status.StyleProperties
---@field bold? boolean
...
---@class customs.status.HighlightTransforms
---@field fg? HexTransformFn foreground color transformation
---@field bg? HexTransformFn background color transformation
---@field style? customs.status.StyleProperties text style properties

---@class customs.status.StatusGroupConfig
---@field base_hl string base highlight group name
---@field transforms customs.status.HighlightTransforms transformation configuration

local M = {}

---@type table<string, customs.status.StatusGroupConfig>
local status_groups = {}
...
---@param transforms? customs.status.HighlightTransforms transformation config with fg, bg, and style properties
...
---@param opts customs.status.StatusOptions options for status line configuration
...
function M.setup(opts)
    vim_utils.create_autocmd({
        events = { "ColorScheme" },
        group_name = "StatusLineHighlights",
