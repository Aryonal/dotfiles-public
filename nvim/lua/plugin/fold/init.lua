...
local indent_foldexpr = require("plugin.fold.indent").indent_foldexpr
local forward_indent_foldexpr = require("plugin.fold.indent").forward_indent_foldexpr
...
function M.setup()
    ...
    o.foldexpr = "v:lua.require('plugin.fold').foldexpr()"
    o.foldlevel = 99
    o.foldlevelstart = 99
    o.foldenable = true
    o.fillchars = [[foldopen:,foldclose:]]
    vim.opt.foldtext = "v:lua.require('plugin.fold').foldtext()"
end
